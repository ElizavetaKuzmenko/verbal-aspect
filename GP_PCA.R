...
data <- read.csv("/home/lizaku/PycharmProjects/verbal-aspect/GP_absolute.csv", header = T, sep = ",")
...
# colored plot
g <- ggbiplot(GP2.princomp, obs.scale = 1, var.scale = 1, ellipse = TRUE, circe = FALSE, groups=dataAdjusted$aspect)
